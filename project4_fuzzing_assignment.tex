...
Clone the course repository from the link provided on Canvas.
...
\begin{itemize}
    \item your patched \texttt{libpng-course/course/course\_vuln.c} file \textbf{or} a patch/diff against the original file,
